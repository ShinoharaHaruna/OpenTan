...
// This errors code refers to the semantics of HTTP status codes
...
// 200 OK
var (
	success = newResponse(200, "Succeeded")
)
...
func NewServerError(code int32, msg string) func(c *gin.Context) {
